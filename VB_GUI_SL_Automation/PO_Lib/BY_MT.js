...
export const Connect_SL = async (CR_Name) => {
  ...
  // Sanjay Edit for OTP
  await W_OTP.Wait_For_Otp("CSS=.verify-otp-and-agree");
  // END OF OTP
...
export const Verify_Buyer_Match = async (ID, PD, GD, QT, PR, LC, PD_CG, QT_l, Per_Qtl, Pick_Up_DT) => {
  try {
    ...
    var item_pos = await GA_5.Find_Match_Pos_1("html/body/div/div/div[2]/div[6]/div/div/div/div/div/div/table/tbody/tr/td[change]/div/div/span/u", ID, 1)
