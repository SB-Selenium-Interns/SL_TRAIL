...
export const T6 = async (ENV_Type, ENV_Type1) => {
  try {
    RS.Write_Log("TC_006", "Verify that, Buyer and Seller are  able to Connect and Reject Respectively ", "")
    console.log("Credientials")

    CL_B.Delete_Data(R.RT("TC_006", "DataSet1", "BY1_UID"), ENV_Type)
    CL_S.Delete_Data(R.RT("TC_006", "DataSet1", "SE1_UID"), ENV_Type)

    await EV.Launcapp(ENV_Type, ENV_Type1)
    await LG.Login_VB(R.RT("TC_006", "DataSet1", "BY1_UID"), R.RT("TC_006", "DataSet1", "BY1_PWD"));
    await BU.Remove_BY_ML()
    await HM.Logout_VB()

    await LG.Login_VB(R.RT("TC_006", "DataSet1", "BY1_UID"), R.RT("TC_006", "DataSet1", "BY1_PWD"));
    await BU.Add_ML(
      await R.RT("TC_006", "DataSet1", "CG"),
      await R.RT("TC_006", "DataSet1", "PD"),
      await R.RT("TC_006", "DataSet1", "VR"),
      await R.RT("TC_006", "DataSet1", "GD")
    );
    await HM.Logout_VB()

    console.log("Starting Actual Scenario")
    await LG.Login_VB(R.RT("TC_006", "DataSet1", "SE1_UID"), R.RT("TC_006", "DataSet1", "SE1_PWD"));
    await SP.Add_PD(
      await R.RT("TC_006", "DataSet1", "CG"),
      await R.RT("TC_006", "DataSet1", "PD"),
      await R.RT("TC_006", "DataSet1", "VR"),
      await R.RT("TC_006", "DataSet1", "GD"),
      await R.RT("TC_006", "DataSet1", "QT"),
      await R.RT("TC_006", "DataSet1", "PR")
  );
    await HM.Logout_VB()
    ...
    await LG.Login_VB(R.RT("TC_006", "DataSet1", "BY1_UID"), R.RT("TC_006", "DataSet1", "BY1_PWD"));
    await BU.Add_Req(
      await R.RT("TC_006", "DataSet1", "CG_PD"),
      await R.RT("TC_006", "DataSet1", "QT"),"",
      await R.RT("TC_006", "DataSet1", "PD"),
      await R.RT("TC_006", "DataSet1", "GD")
    );
